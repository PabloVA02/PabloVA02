...
| fichero | Título | Autor | Año |
|---|---|---|---|
| `alicia-maravillas.png` | Alicia en el país de las maravillas | Lewis Carroll | 1865 |
| `come-reza-ama.png` | Come, reza, ama | Elizabeth Gilbert | 2006 |
| `kite-runner.png` | Cometas en el cielo | Khaled Hosseini | 2003 |
| `cronica-muerte-anunciada.png` | Crónica de una muerte anunciada | Gabriel García Márquez | 1981 |
| `amor-tiempos-colera.png` | El amor en los tiempos del cólera | Gabriel García Márquez | 1985 |
| `codigo-da-vinci.png` | El código Da Vinci | Dan Brown | 2003 |
| `jekyll-hyde.png` | El extraño caso del doctor Jekyll y el señor Hyde | R. L. Stevenson | 1886 |
| `perfume.png` | El perfume | Patrick Süskind | 1985 |
| `el-proceso.png` | El proceso | Franz Kafka | 1925 |
| `tiempo-entre-costuras.png` | El tiempo entre costuras | María Dueñas | 2009 |
| `jane-eyre.png` | Jane Eyre | Charlotte Brontë | 1847 |
| `historia-interminable.png` | La historia interminable | Michael Ende | 1979 |
| `ladrona-libros.png` | La ladrona de libros | Markus Zusak | 2005 |
| `juegos-hambre.png` | Los juegos del hambre | Suzanne Collins | 2008 |
...
| fichero | Título | Autor | Año |
|---|---|---|---|
| `actua-dama-piensa-hombre.png` | Actúa como dama, piensa como hombre | Steve Harvey | 2009 |
| `cambia-el-chip.png` | Cambia el chip | Chip y Dan Heath | 2010 |
| `ninos-escuchen.png` | Cómo hablar para que los niños escuchen | Adele Faber y Elaine Mazlish | 1980 |
| `adulto-relaciones.png` | Cómo ser un adulto en las relaciones | David Richo | 2002 |
| `despertando-gigante.png` | Despertando al gigante interior | Tony Robbins | 1991 |
| `arte-no-amargarse.png` | El arte de no amargarse la vida | Rafael Santandreu | 2011 |
| `ego-es-el-enemigo.png` | El ego es el enemigo | Ryan Holiday | 2016 |
| `placebo-eres-tu.png` | El placebo eres tú | Joe Dispenza | 2014 |
| `vendedor-mas-grande.png` | El vendedor más grande del mundo | Og Mandino | 1968 |
| `enamorate-de-ti.png` | Enamórate de ti | Walter Riso | 2012 |
| `focus-goleman.png` | Focus | Daniel Goleman | 2013 |
| `haz-cosas-dificiles.png` | Haz cosas difíciles | Steve Magness | 2022 |
| `hazte-rico-durmiendo.png` | Hazte rico mientras duermes | Ben Sweetland | 1962 |
| `ideas-que-pegan.png` | Ideas que pegan | Chip y Dan Heath | 2007 |
| `actitud-mental-positiva.png` | La actitud mental positiva | Napoleon Hill y W. Clement Stone | 1959 |
| `alegria-perderse.png` | La alegría de perderse | Tanya Dalton | 2021 |
| `buena-suerte.png` | La buena suerte | Rovira y Trías de Bes | 2004 |
| `disciplina-es-destino.png` | La disciplina es el destino | Ryan Holiday | 2022 |
| `ley-de-atraccion.png` | La ley de la atracción | Esther y Jerry Hicks | 2006 |
| `mente-justos.png` | La mente de los justos | Jonathan Haidt | 2012 |
| `quietud-es-la-clave.png` | La quietud es la clave | Ryan Holiday | 2019 |
| `21-leyes-liderazgo.png` | Las 21 leyes irrefutables del liderazgo | John C. Maxwell | 1998 |
| `cinco-heridas.png` | Las cinco heridas que impiden ser uno mismo | Lise Bourbeau | 2000 |
| `modelos-manson.png` | Modelos | Mark Manson | 2011 |
...
| `chingona-dinero.png` | Eres un chingón haciendo dinero | Jen Sincero | 2017 |
| `bolsa-o-vida.png` | La bolsa o la vida | Robin y Dominguez | 1992 |
| `ciencia-hacerse-rico.png` | La ciencia de hacerse rico | Wallace D. Wattles | 1910 |
| `dieta-financiera.png` | La dieta financiera | Chelsea Fagan y Lauren Ver Hage | 2018 |
| `oceano-azul.png` | La estrategia del océano azul | Kim y Mauborgne | 2005 |
| `guerra-chips.png` | La guerra de los chips | Chris Miller | 2022 |
| `transformacion-dinero.png` | La transformación total de su dinero | Dave Ramsey | 2003 |
| `cinco-disfunciones.png` | Las cinco disfunciones de un equipo | Patrick Lencioni | 2002 |
| `cuatro-pilares-inversion.png` | Los cuatro pilares de la inversión | William Bernstein | 2002 |
| `primeros-90-dias.png` | Los primeros 90 días | Michael Watkins | 2003 |
| `maestro-dinero.png` | Maestro del dinero: el juego | Tony Robbins | 2014 |
| `ford-vida-obra.png` | Mi vida y obra | Henry Ford | 1922 |
| `principios-orden-mundial.png` | Principios para enfrentarse al nuevo orden mundial | Ray Dalio | 2021 |
| `psicologia-venta.png` | Psicología de ventas | Brian Tracy | 2004 |
| `recompra-tu-tiempo.png` | Recompra tu tiempo | Dan Martell | 2023 |
| `retirate-joven-rico.png` | Retírate joven y rico | Robert Kiyosaki | 2001 |
...
| fichero | Título | Autor | Año |
|---|---|---|---|
| `cerebro-hambriento.png` | El cerebro hambriento | Stephan Guyenet | 2017 |
| `cuerpo-4-horas.png` | El cuerpo perfecto en 4 horas | Tim Ferriss | 2010 |
...
| fichero | Título | Autor | Año |
|---|---|---|---|
| `termina-acuff.png` | ¡Termina! | Jon Acuff | 2017 |
| `treinta-dias.png` | 30 días | Marc Reklau | 2014 |
