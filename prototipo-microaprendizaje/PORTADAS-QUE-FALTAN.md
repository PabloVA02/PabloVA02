...
Al 2026-08-25: **418 libros** en el catálogo, **265 con cubierta tuya**, **153 sin ella**.

## Cómo tiene que ser

- Fichero PNG a **1024 × 1536**, y el nombre del fichero es **el id exacto** de la tabla.
- Como las 216 que ya hay: **título, autor y un dibujo** que cuente el libro.
...
> El 25 de agosto retiré 81 de tus portadas creyendo que les faltaba mensaje.
> Estaban todas ilustradas y estaban bien. Se devolvieron el mismo día y no se
> perdió ninguna. Ninguna portada se retira sin que Pablo lo diga.


# BLOQUE 1 — 50 libros que YA SE PUEDEN LEER y salen sin portada
...
# BLOQUE 2 — 103 libros del catálogo aún sin escribir
...
| `prision-americana` | Prisión americana | Shane Bauer | 2018 |
| `como-llegamos-aqui` | Cómo llegamos aquí | Steven Johnson | 2014 |
| `ucrania-relatos` | Ucrania en varios relatos | Volodímir Yermolenko | 2019 |
...
| `vacas-sagradas` | Matar a las vacas sagradas | Garrett B. Gunderson | 2008 |
| `dieta-financiera` | La dieta financiera | Chelsea Fagan y Lauren Ver Hage | 2018 |
| `principios-orden-mundial` | Principios para enfrentarse al nuevo orden mundial | Ray Dalio | 2021 |
| `guerra-chips` | La guerra de los chips | Chris Miller | 2022 |
