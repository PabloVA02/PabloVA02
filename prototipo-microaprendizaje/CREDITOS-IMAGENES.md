...
**El pollito del cupón** y **la caja de regalo**
(`src/ilustraciones/`), **los once emoticonos de los objetivos**
(`src/emoticonos-metas.ts`) y **los seis de los géneros del buscador**
(`src/emoticonos-generos.ts`) los aportó Pablo. No
