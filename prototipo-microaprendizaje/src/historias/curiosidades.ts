    ...
    paginas: [
      {
        ...
        texto:
          ...
          "aceptar algo que cuesta: el Sol no es una bombilla de intensidad fija.</p>",
      },
      {
        rotulo: "El Sol tiene mucho más tiempo por delante que nosotros",
        texto:
          "<p>Se está volviendo más <strong>brillante</strong>, y lleva haciéndolo desde el día " +
          "mismo en que se encendió.</p><p>El motivo está en su centro. Allí dentro el hidrógeno " +
          "se fusiona en helio, y el helio resultante ocupa menos espacio que el hidrógeno del " +
          "que procede, así que el núcleo se va comprimiendo poco a poco bajo su propio peso. Al " +
          "comprimirse se calienta, al calentarse fusiona más deprisa, y al fusionar más deprisa " +
          "alumbra más. Es un bucle que se alimenta a sí mismo y para el que no existe ningún " +
          "freno posible.</p><blockquote class=\"rayo\"><p>El Sol no necesita morir para acabar " +
          "con la vida en la Tierra. Le basta con seguir haciendo exactamente lo que lleva " +
          "haciendo desde el principio.</p></blockquote><p>¿Sabías que…? Cuando se formó la " +
          "Tierra, el Sol brillaba un treinta por ciento menos que hoy.</p>",
      },
      {
        rotulo: "El Sol tiene mucho más tiempo por delante que nosotros",
        texto:
          "<p>Si pusiéramos nuestro planeta actual, con esta misma atmósfera, bajo aquella " +
          "estrella más apagada, la temperatura media sería de siete grados bajo cero y estaría " +
          "congelado de polo a polo. La vida no empezó bajo un sol como el nuestro, sino bajo uno " +
          "mucho más tibio, y lleva cuatro mil quinientos millones de años con la calefacción " +
          "subiendo despacio.</p><h3>El final no llegará por fuego, sino por " +
      ...
      },
      {
        ...
        texto:
          "<p>El mecanismo es indirecto, y por eso resulta tan difícil de anticipar. A medida que " +
          "el Sol calienta, la roca de los continentes se erosiona más deprisa, y esa erosión " +
          "consume dióxido de carbono del aire. Se trata de una reacción química que lleva miles " +
          "de millones de años funcionando como el termostato del planeta: cuanto más calor hace, " +
          "más rápido trabaja, y más CO₂ retira de la atmósfera. Es, en buena medida, lo que nos " +
          "ha mantenido templados todo este tiempo.</p><p>El problema es que las plantas " +
          "necesitan ese mismo CO₂ para hacer la <strong>fotosíntesis</strong>. Es, literalmente, " +
          "su comida. Y llega un punto en que el termostato ha limpiado el aire de carbono hasta " +
          "un nivel en el que ya no pueden seguir alimentándose. Con ellas se cae todo lo que " +
          "depende de ellas, que en tierra firme es prácticamente todo.</p>",
      },
      {
        rotulo: "El final no llegará por fuego, sino por asfixia",
        texto:
          "<p>El cálculo clásico sitúa ese momento dentro de unos mil millones de años. Sin " +
          "embargo, trabajos recientes lo alargan hasta cerca de mil ochocientos millones y, de " +
          "paso, cambian la causa de la muerte: las plantas no llegarían a quedarse sin comida, " +
          "sino que se detendrían de puro calor, por encima de los sesenta y cinco grados. Los " +
          "océanos hierven bastante más tarde, aunque para entonces ya no quedará nadie para " +
          "verlo.</p><blockquote class=\"rayo\"><p>El mismo termostato que ha mantenido templada " +
          "a la Tierra durante miles de millones de años es lo que acabará dejando a las plantas " +
          "sin nada que respirar.</p></blockquote><h3>Antes de apagarse, el Sol se volverá " +
          "enorme</h3><p>Todo lo anterior ocurrirá con un Sol todavía normal, en plena forma.</p>",
      },
      {
        rotulo: "Antes de apagarse, el Sol se volverá enorme",
        texto:
          "<p>Su propio final llega mucho después, y no se parece en nada a " +
          "apagarse.</p><p>Cuando por fin agote el hidrógeno de su núcleo, el Sol hará justo lo " +
          "contrario: se hinchará. Se convertirá en una <strong>gigante roja</strong> de unas " +
          "doscientas cincuenta y seis veces su tamaño actual, lo que significa que su superficie " +
          "llegará más lejos de donde ahora mismo orbita la Tierra.</p><p>Mercurio será el " +
          "primero en desaparecer. Venus le seguirá unos dos millones y medio de años después. Y " +
          "un millón de años más tarde le tocará el turno a nuestra órbita, dentro de siete mil " +
          "quinientos noventa millones de años.</p><p>Lo que no está tan claro es qué se va a " +
          "encontrar ahí cuando llegue.</p><blockquote class=\"rayo\"><p>El Sol no se irá " +
          "apagando poco a poco. Antes de eso crecerá hasta ser más grande que la órbita en la " +
          "que hoy gira la Tierra.</p></blockquote>",
      },
      {
        rotulo: "La Tierra estará a punto de escapar",
        texto:
          "<h3>La Tierra estará a punto de escapar</h3><p>Aquí ocurre algo que parece escrito por " +
          "un guionista, y es la parte más fascinante de toda la historia.</p><p>Para poder " +
          "hincharse tanto, el Sol tiene que soltar lastre. Perderá alrededor de un tercio de su " +
          "masa, expulsada al espacio en forma de un viento lento y continuo durante millones de " +
          "años. Y menos masa significa menos gravedad: su agarre sobre los planetas se irá " +
          "aflojando poco a poco.</p><p>Así que las órbitas se abren. La Tierra empezará a " +
          "alejarse, empujada hacia fuera por la propia decadencia de la estrella que viene a " +
          "devorarla. Y aquí está lo interesante: ese efecto, por sí solo, bastaría para " +
          "salvarla.</p>",
      },
      {
        rotulo: "La Tierra estará a punto de escapar",
        texto:
          "<p>La órbita crecería lo justo para quedar por fuera del Sol hinchado.</p><p>Sin " +
          "embargo, hay una segunda fuerza tirando en sentido contrario. La gigante roja " +
          ...
          "aguantado siete mil quinientos millones.</p>",
      },
      {
        rotulo: "La Tierra estará a punto de escapar",
        texto:
          "<p>Por muy poco.</p><p>Pero modelos más recientes calculan que ese tirón hacia dentro " +
          "es más débil de lo que se creía, y devuelven a la Tierra a la lista de supervivientes. " +
          ...
          "sabemos medir bien en estrellas como la nuestra.</p><blockquote " +
          "class=\"rayo\"><p>Sabemos con precisión la fecha de la cita entre el Sol y la Tierra. " +
          "Todavía no sabemos cómo termina.</p></blockquote><h3>Lo que quede seguirá enfriándose " +
          "más tiempo del que lleva existiendo el universo</h3><p>De lo que no hay ninguna duda " +
          "es de lo que quedará al final.</p>",
      },
      {
    ...
    paginas: [
      {
        ...
        texto:
          ...
          "algunas bastante sólidas, pero ninguna se ha impuesto del todo.</p>",
      },
      {
        rotulo: "Bostezamos todos los días y nadie sabe por qué",
        texto:
          "<p>Es de esas cosas que hacemos a diario y que siguen siendo, en el sentido literal de " +
          "la palabra, un misterio.</p><p>Lo que sí sabemos con certeza es que buena parte de lo " +
          "que nos han contado sobre el bostezo es falso.</p><blockquote " +
          "class=\"rayo\"><p>Bostezamos desde antes de nacer y lo compartimos con casi todos los " +
          "animales de sangre caliente, pero seguimos sin saber para qué " +
      ...
      },
      {
        ...
        texto:
          "<p>También es la que se desmontó hace décadas.</p><p>El psicólogo Robert Provine hizo " +
          "el experimento evidente. Si la teoría fuese cierta, respirar aire cargado de oxígeno " +
          "debería reducir los bostezos, y respirar aire con más dióxido de carbono debería " +
          "dispararlos. Probó las dos cosas.</p><p>No pasó nada. Ni el oxígeno extra los redujo, " +
          "ni el CO₂ los aumentó. Después lo intentó con ejercicio físico, que duplica el ritmo " +
          "respiratorio, y el resultado fue el mismo: la gente respiraba el doble y bostezaba " +
          "exactamente igual que antes.</p><p>La conclusión es incómoda pero clara. El bostezo y " +
          "la respiración funcionan por mecanismos distintos, y uno no está ahí para arreglar al " +
          "otro.</p><p>Hay además un detalle que remata el asunto.</p>",
      },
      {
        rotulo: "La explicación del oxígeno lleva décadas desmentida",
        texto:
          "<p>Los fetos bostezan dentro del útero, cuando sus pulmones todavía no funcionan y el " +
          "oxígeno les llega por el cordón umbilical. Difícilmente pueden estar cogiendo " +
          "aire.</p><blockquote class=\"rayo\"><p>Respirar oxígeno puro no reduce los bostezos, y " +
          "respirar dióxido de carbono no los aumenta. Bostezar no tiene nada que ver con el aire " +
          "que te falta.</p></blockquote><h3>La hipótesis más sólida es que el bostezo funciona " +
          "como un radiador</h3><p>Entonces, ¿qué pasa realmente cuando bostezas? La explicación " +
          "que más fuerza ha ganado en los últimos años es también la más inesperada: <strong>el " +
          "bostezo sirve para enfriarte el cerebro.</strong></p><p>El cerebro es un órgano " +
          "caro.</p>",
      },
      {
        rotulo: "La hipótesis más sólida es que el bostezo funciona como un radiador",
        texto:
          "<p>Consume una enorme cantidad de energía, genera mucho calor como consecuencia, y " +
          "solo funciona bien dentro de un margen de temperatura bastante estrecho. La hipótesis " +
          ...
          "pero las pruebas se van acumulando:</p><ul><li>Enfriar la frente reduce los bostezos " +
          "contagiosos. Respirar por la nariz, que también baja la temperatura del cerebro, los " +
          "reduce igual.</li></ul>",
      },
      {
        rotulo: "La hipótesis más sólida es que el bostezo funciona como un radiador",
        texto:
          "<ul><li>En ratas, la temperatura cerebral sube justo antes del bostezo y baja " +
          "inmediatamente después.</li><li>En personas con bostezos excesivos, la temperatura " +
          "oral cae unos 0,4 grados tras el episodio.</li><li>La frecuencia de bostezos aumenta " +
          "con la temperatura ambiente, pero se desploma cuando el aire de fuera se acerca a la " +
          "temperatura corporal. Tiene sentido: si el aire ya no está más frío que tú, ventilar " +
          "no sirve de nada.</li></ul><p>¿Sabías que…? El estudio más grande que se ha hecho " +
          "jamás sobre el tema analizó 1.291 bostezos de 101 especies distintas, entre mamíferos " +
          "y aves. Encontró que cuanto mayor es el cerebro de un animal, y cuantas más neuronas " +
          "tiene, más dura su bostezo. Un mamífero de cerebro medio bosteza unos 3,4 segundos; un " +
          "ave, apenas 1,5.</p>",
      },
      {
        rotulo: "La hipótesis más sólida es que el bostezo funciona como un radiador",
        texto:
          "<p>Encaja exactamente con lo que predice la teoría: un cerebro más grande necesita más " +
          "tiempo de ventilación.</p><blockquote class=\"rayo\"><p>Cuanto más grande es el " +
          ...
          "misterio, sino un misterio distinto.</p>",
      },
      {
        rotulo: "El contagio es un misterio aparte",
        texto:
          "<p>Aunque bostezar sirva para enfriar tu cerebro, eso no explica en absoluto por qué " +
          "el bostezo de otra persona tendría que enfriar el tuyo.</p><p>La pista que más se " +
          "maneja apunta a lo social. El contagio es bastante más fuerte entre personas cercanas " +
          "—familia, pareja, amigos— que entre desconocidos, lo que sugiere que está enganchado a " +
          "los mecanismos de empatía y de sincronización dentro de un grupo.</p><p>Y en mayo de " +
          "2026 llegó el dato más desconcertante hasta la fecha. Un equipo publicó en <em>Current " +
          "Biology</em> un experimento con 38 embarazadas en el tercer trimestre: les pusieron " +
          "vídeos de gente bostezando mientras observaban al feto por ecografía.</p>",
      },
      {
        rotulo: "El contagio es un misterio aparte",
        texto:
          "<p>El 64 % de las madres bostezó viendo los vídeos. Y alrededor del 53 % de los fetos " +
          "bostezó después, normalmente al minuto y medio de haberlo hecho su madre.</p><p>Es un " +
          "estudio pequeño, y los propios autores admiten que no saben cómo ocurre —¿por el " +
          "movimiento?, ¿por alguna señal hormonal?— ni si esos bostezos prenatales sirven para " +
          "algo en absoluto.</p><p>Así que la situación, resumida, es esta: hacemos algo " +
          "constantemente, empezamos a hacerlo antes de nacer, se nos contagia de los demás, y " +
          "seguimos sin saber por qué ninguna de las tres cosas.</p><blockquote " +
