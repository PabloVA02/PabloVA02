...
/* ==========================================================================
   ...
   Diez temas, llegados el 28 de agosto de 2026. Los originales, tal como los
   mandó, están en `referencia/textos-de-pablo/28-agosto-tarde/`, y este
   fichero lo escribe `scripts/temas.mjs` leyéndolos: un `diff` contra ellos
   dice en un segundo si aquí falta o sobra algo.
   ...
   Las seis nuevas van con su `encargo` y enseñan el cartel de color mientras
   tanto —para eso existe—, y hay que buscárselas. Cada tema trae además, en
