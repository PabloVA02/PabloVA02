...
| `fichas-personalidades/` | veinte FICHAS abiertas, no resúmenes | **La única de fichas, y era el hueco que quedaba.** Los «Aprenderás» enteros por primera vez: son cuatro, en minúscula, continuando la frase del rótulo. Y el cajón de personalidades —Michelle Obama, Diana, Henry Ford, Cameron Diaz— del que sale nuestro género «Vidas». Apartado 5 |
| `ciento-doce-tecnicas/` | un resumen de las ciento doce técnicas de meditación tántrica, 8 páginas | **La peor de las diecisiete, y la más útil por eso.** Ocho páginas sin una fecha, sin un nombre propio y sin un lugar: ni el siglo del texto, ni quién lo comenta, ni de dónde sale. De aquí sale la prueba de la cifra y el nombre, apartado 4 |
| `gran-apuesta/` | *La gran apuesta*, de Michael Lewis, 7 páginas | **La mejor de las de economía.** Cómo se cuenta un asunto técnico con personas: Eisman, Burry, Paulson, el remero olímpico de Cornwall Capital. Define «permutas de incumplimiento crediticio» la primera vez y en español. Y su «Prueba esto» recomienda ver la película |
| `economia-rosquilla/` | *Economía rosquilla*, de Kate Raworth, 8 páginas | El diagrama contado con palabras: dos anillos, la base social dentro y el techo ecológico fuera. Y el error de al lado: doce necesidades numeradas seguidas, que es un índice, no una página |
